...
export const LazyImage = memo(({ src, alt, className, fallbackSrc, ...props }) => {
...
export const withPerformanceOptimization = (Component, shouldRerender = () => true) => {
...
export const VirtualizedList = memo(({ items, renderItem, itemHeight = 80 }) => {
...
export const logBundlePerformance = () => {
  if (import.meta.env.MODE === 'development') {
    ...
    console.log('Bundle chunks loaded:', document.querySelectorAll('script[src]').length);
    console.log('Images loaded:', document.querySelectorAll('img').length);
    console.log('Memory usage:', navigator.memory ? navigator.memory.usedJSHeapSize : 'Not available');
    console.groupEnd();
  }
};
